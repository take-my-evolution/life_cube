...
class LichenRules(Rules):
    ...
    GENE_DOCS = {
        ...
        "substrate": "Где вид кормится: 0 — голый камень, 1 — почва. Вся "
                     "эволюция «лишайника» — это сдвиг гена вправо по мере того, "
                     "как камень превращается в почву.",
        "erode": "Как сильно вид разъедает камень под собой. Работает во влажных "
                 "местах и сам же готовит почву будущим конкурентам.",
        "rain": "Польза от дождя: одним видам он корм, другим — просто сырость.",
        "up": "Рост вверх. 0 — плоская корка, выше — попытки оторваться от земли.",
        "absorb": "Сколько света клетка съедает, затеняя соседей снизу.",
        "metabolism": "Трата энергии за поколение.",
        "repro": "Порог энергии для деления.",
        "mut": "Базовая частота мутаций сверх стрессовой.",
    }
