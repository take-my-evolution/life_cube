...
class TerraRules(Rules):
    ...
    GENE_DOCS = {
        "light": "Насколько хорошо вид усваивает свет. Множитель ко всему, что "
                 "клетка зарабатывает за поколение.",
        "stone": "Кормится ли вид на голом камне. Единственная ниша лишайника; "
                 "камня со временем становится меньше, и одного этого гена мало.",
        "soil": "Кормится ли вид на почве. Почва появляется из камня, поэтому "
                "этот ген — главный приз эволюции в «терре».",
        "water": "Кормится ли вид под водой. Полезен в озёрах и руслах, где "
                 "света мало, а конкурентов почти нет.",
        "erode": "Как сильно вид грызёт камень под собой. Работает только на "
                 "мокром голом камне; одна клетка камня даёт несколько клеток "
                 "почвы — обмен неравноценный, мир зарастает.",
        "enrich": "Бактерия: заражает почву под собой и вокруг. Без этого гена "
                  "плодородия в мире не появится вовсе.",
        "symbiont": "Насколько вид беспомощен на «пустой» почве. Высокий "
                    "symbiont = растение, которое садится только там, где уже "
                    "поработали бактерии.",
        "up": "Вероятность отправить потомка вверх, а не вбок. Так строится "
              "стебель — и так растение выбирается из воды на свет.",
        "absorb": "Сколько света клетка съедает, затеняя всё под собой.",
        "metabolism": "Трата энергии за поколение. Внизу диапазона стоит порог: "
                      "иначе эволюция уходила не в нишу, а в «жизнь на объедках».",
        "repro": "Порог энергии для деления; потомку достаётся половина.",
        "mut": "Собственная частота мутаций вида — сверх той, что даёт стресс от "
               "плохой ниши.",
    }
