...
class Rules:
    ...
    # Гены, которые случайной ручке трогать нельзя: они задают не силу вида, а
    # его РОЛЬ в мире. Крутнуть их — не «другой мох», а мох со стволом.
    FIXED_GENES = ("trophic", "speed")

    def fixed_genes(self, cfg):
        return tuple(self.FIXED_GENES)
